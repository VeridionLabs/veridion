...
import {
  MessageSquare, Send, Shield, Bot, User, FileSearch, AlertTriangle,
    ...
    <div className="flex h-[calc(100vh-5rem)] flex-col">
      <div className="mb-4 flex items-center justify-between">
        ...
        <select
          ...
          className="rounded-lg border bg-background px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
        >
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                <textarea
                  ...
                  rows={1}
                  className="w-full resize-none rounded-lg border bg-background px-4 py-2.5 pr-10 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring"
                />
                <button
                  onClick={() => sendMessage(input)}
                  disabled={!input.trim() || loading}
                  className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-1 text-muted-foreground hover:text-foreground disabled:opacity-30"
                >
