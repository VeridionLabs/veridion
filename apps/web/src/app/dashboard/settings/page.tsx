      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          <div className="rounded-xl border bg-card p-6">
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <input type="text" className="mt-1 w-full rounded-lg border bg-background px-3 py-2 text-sm" placeholder="Your name" />
              </div>
              <div>
                <label className="text-sm font-medium">Email</label>
                <input type="email" className="mt-1 w-full rounded-lg border bg-background px-3 py-2 text-sm" placeholder="you@example.com" disabled />
              </div>
              <div>
                <label className="text-sm font-medium">Wallet Address (Stellar)</label>
                <input type="text" className="mt-1 w-full rounded-lg border bg-background px-3 py-2 text-sm font-mono" placeholder="G..." />
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border bg-card p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground">Manage API keys for programmatic access to Veridion.</p>
