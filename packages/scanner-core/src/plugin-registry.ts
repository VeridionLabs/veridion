...
/**
 * Builds the default plugin registry used by the scanner. New plugins are
 * registered here as they land; consumers can still compose a custom registry
 * with {@link PluginRegistry} directly.
 */
